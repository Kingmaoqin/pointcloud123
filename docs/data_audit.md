...
This smoke association does not force points beyond the threshold into a component. Full-scale association over all 584M ASC lines should be run as a chunked batch job.
